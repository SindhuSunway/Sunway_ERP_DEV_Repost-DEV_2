...
public class EmpSpecificReport
{
  public EmpSpecificReport()
  {
  }
  ...
  {System.out.println("Run Reort Action");
    DCIteratorBinding empIter = (DCIteratorBinding) getBindings().get("HrEmplInfoView1Iterator");
    String empId = empIter.getCurrentRow().getAttribute("EmployeeNo").toString();
    Map m = new HashMap();
    m.put("employee_no", empId);
      System.out.println(""+empId);
    try
    {
      runReport("NewEmpSpecificRep.jasper", m);
