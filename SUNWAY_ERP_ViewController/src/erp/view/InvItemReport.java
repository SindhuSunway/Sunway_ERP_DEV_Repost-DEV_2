...
public class InvItemReport
{
  public InvItemReport()
  {
  }


    public String runReport()
  {System.out.println("Run Inv Report Action");
    DCIteratorBinding itemIter = (DCIteratorBinding) getBindings().get("InvInventoryView1Iterator");
    String item = itemIter.getCurrentRow().getAttribute("ItemCode").toString();
    Map m = new HashMap();
    m.put("itemCode", item);
      System.out.println(""+item);
    try
    {
      runReport("NewInventoryItemReport.jasper", m);
